...
public class OcOngoingCasesController {
    ...
    static {
        messageList.add(new OcOngoingCases_Model("1010","SIBayezid","31313","Murder",LocalDate.of(2025,4,10),"Suspect has a deep cut mark in the right hand","Active"));
        messageList.add(new OcOngoingCases_Model("1011","SISiam","31333","Stolen item",LocalDate.of(2025,4,9),"Suspect had a black net mask on his face","Active"));
        messageList.add(new OcOngoingCases_Model("1012","SIRasel","50005","Suicide",LocalDate.of(2025,4,13),"Suspect info not yet found","Active"));
        messageList.add(new OcOngoingCases_Model("1013","SIRasel","50005","Road rash",LocalDate.of(2025,4,14),"Suspect driver was intoxicated while driving","Active"));
        messageList.add(new OcOngoingCases_Model("1014","ASIRubel","44444","Chain Snatch",LocalDate.of(2025,4,12),"Suspect has multiple scar in both hands","Active"));
        messageList.add(new OcOngoingCases_Model("1015","ASIShamim","11211","Murder",LocalDate.of(2025,4,11),"Suspect was caught ","Completed"));
